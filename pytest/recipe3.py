...
class RomanNumeralConverterTest(unittest.TestCase):
    ...
    def test_parsing_century(self):
        """This test method is coded to fail for demonstration"""
        self.assertEquals(10, self.cvt.convert_to_decimal("C"))
...
if __name__ == "__main__":
    ...
    suite = loader.loadTestsFromTestCase(RomanNumeralConverterTest)
